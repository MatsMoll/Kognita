        ...
        'math':function(context){
            ...
            self.initialize = function(){
                ...
                let body=`<div class="form-group">
                    ...
                    <p><input id="note-latex-` + id + `" class="form-control"></p>
                    <p>Preview: </p>
                    <div style="min-height:20px;"><span class="note-math-dialog-` + id + `"></span></div>
    
                    <script>
                    document.getElementById('note-latex-` + id + `').addEventListener('keyup', renderMath);

                    function renderMath(){
                        let $mathElement = $('.note-math-dialog-` + id + `');
            ...
            self.show = function(){
                ...
                var mathSp = self.$dialog.find('.note-math-dialog-' + id);
                let $latexSpan = self.$dialog.find('#note-latex-' + id);
                ...
                if ($selectedMathNode === null) {
                    ...
                    let hiddenLatex = $selectedMathNode.find('.note-latex-' + id).text();
                    $latexSpan.val(hiddenLatex);
                    katex.render(hiddenLatex, mathSp[0]);
                }
                ...
                self.showMathDialog(mathInfo).then(function(mathInfo){
                    ...
                    let $mathNodeClone = mathSp.clone();
                    let $latexNode = $('<span>');
                    ...
                    $mathNodeClone.removeClass('note-math-dialog-' + id).addClass('note-math');
